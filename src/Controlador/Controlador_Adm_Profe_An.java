...
import estructuras.EstraerDatosDocente;
import estructuras.EstraerDatosEstudiante;
    ...
    private class EventoValidar implements EventHandler<ActionEvent> {
        ...
        public void handle(ActionEvent event) {
         ...
         private void registrar(TableHash tabladatdoce) {
                ...
                String Usuario=vista.getTfUser().getText();
                String Correo=vista.getTfCorreo().getText();
                String Contraseña=vista.getTfConfContra().getText();
            
            EstraerDatosDocente estraer = new EstraerDatosDocente(Id, Nombre, Apellido, Usuario, Correo, Contraseña);
        }
    }
